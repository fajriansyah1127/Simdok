          ...
          <form action="/create/user" method="POST" enctype="multipart/form-data">
            @csrf
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                       <input type="text" id="Jabatan" name="Jabatan" class="form-control" placeholder="Masukkan Jabatan ex Magang, Kadep Gadai">  
                       <div class ="text-danger">
                        @error('Jabatan')
                        {{ $message }}
                        @enderror
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                        <input type="text" id="Kontak" name="Kontak" class="form-control " placeholder="Masukkan Nomor telephone">  
                        <div class ="text-danger">
                          @error('Kontak')
                          {{ $message }}
                          @enderror
